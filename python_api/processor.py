...
def df_preview():
    ...
    fig_json_p2 = json.loads(json.dumps(p2, cls=PlotlyJSONEncoder))
    fig_json_p3 = json.loads(json.dumps(p3, cls=PlotlyJSONEncoder))
    fig_json_p4 = json.loads(json.dumps(p4, cls=PlotlyJSONEncoder))
    if heat_maps_check==1:
        fig_json_sideplot = json.loads(json.dumps(sidechart, cls=PlotlyJSONEncoder))
    else:
        fig_json_sideplot = json.loads(json.dumps(sidechart, cls=PlotlyJSONEncoder))
    fig_json_chart1plot = json.loads(json.dumps(chart1, cls=PlotlyJSONEncoder))
    fig_json_chart2plot = json.loads(json.dumps(chart2, cls=PlotlyJSONEncoder))
    ...
    return {
        ...
        "p3_plot": fig_json_p3,
        "p4_plot": fig_json_p4,
        "sideplot": fig_json_sideplot,
        "chart1plot": fig_json_chart1plot,
        "chart2plot": fig_json_chart2plot,

        "alpdes": alpdes.to_dict(),
        "numdes": numdes.to_dict(),
        ...
        "pfbr": response_pfbr,
        "pfar": response_pfar,
        "pfbur": response_pfbur,

        "frn": notes_response(filtered_result_note),
        "fpn": notes_response(filtered_pie_note),
        "fbn": notes_response(filtered_box_note),
        "fln": notes_response(filtered_line_note),
        "fhn": notes_response(filtered_histogram_note),
        "fsn": notes_response(filtered_scatter_note),
        "fan": notes_response(filtered_area_note),
        "fbun": notes_response(filtered_bubble_note),
